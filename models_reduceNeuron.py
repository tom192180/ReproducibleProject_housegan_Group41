...
class Discriminator(nn.Module):
    def __init__(self):
        ...
        self.encoder = nn.Sequential(
            *conv_block(7, 12, 3, 1, 1, act="leaky"),
            *conv_block(12, 12, 3, 1, 1, act="leaky"),
            *conv_block(12, 12, 3, 1, 1, act="leaky"))
        self.l1 = nn.Sequential(nn.Linear(10, 6 * 32 ** 2))
        self.cmp_1 = CMP(in_channels=12)
        self.downsample_1 = nn.Sequential(*conv_block(12, 12, 3, 2, 1, act="leaky"))
        self.cmp_2 = CMP(in_channels=12)
        self.downsample_2 = nn.Sequential(*conv_block(12, 12, 3, 2, 1, act="leaky"))
        self.decoder = nn.Sequential(
            *conv_block(12, 256, 3, 2, 1, act="leaky"),
